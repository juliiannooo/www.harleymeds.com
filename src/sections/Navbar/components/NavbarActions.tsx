export const NavbarActions = () => {
  return (
    <div className="items-center box-border caret-transparent gap-x-2 flex min-h-[auto] min-w-[auto] outline-[3px] gap-y-2 md:gap-x-4 md:gap-y-4">
      <a
        href="https://ouraring.com/de/cart"
        className="relative text-white box-border caret-transparent block h-10 leading-4 min-h-[auto] min-w-[auto] outline-[3px] text-center w-10 border rounded-[3.35544e+07px] border-solid border-[oklab(0.999994_0.0000455678_0.0000200868_/_0.25)] md:h-12 md:w-12"
      >
        <span className="content-center items-center box-border caret-transparent gap-x-2 inline-flex h-full justify-center outline-[3px] gap-y-2 w-full">
          <span className="box-border caret-transparent block min-h-[auto] min-w-[auto] outline-[3px]">
            <img
              src="https://c.animaapp.com/mrtmz843YzbOCE/assets/icon-5.svg"
              alt="Icon"
              className="box-border caret-transparent h-[22px] outline-[3px] w-[21px]"
            />
